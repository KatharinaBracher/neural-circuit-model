...
#drawio -x -f pdf -o figures/supp_interIregime.pdf figures/supp_interIregime.drawio.svg
#drawio -x -f pdf -o figures/supp_interI.pdf figures/supp_interI.drawio.svg
#drawio -x -f pdf -o figures/supp_highI.pdf figures/supp_highI.drawio.svg
#drawio -x -f pdf -o figures/supp_experiment.pdf figures/supp_experiment.drawio.svg
#drawio -x -f pdf -o figures/supp_experiment_high.pdf figures/supp_experiment_high.drawio.svg
#drawio -x -f pdf -o figures/supp_othererror.pdf figures/supp_othererror.drawio.svg
