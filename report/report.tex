...
\begin{equation} \label{MSE}
	...
	\end{split}
\end{equation}
%the mean squared error was minimized, which is defined as the sum of the squared bias and variance of the mean reproductions 
...
\begin{figure}[ht]
	...
	\todo{rename optimization to error minimitzinh}
