...
\todo{only 1 author citation bib}

\todo{Add here an outline paragraph for the introduction}
...
\todo{outline, first intermediate input regime then in sectoin 3 high regime is discussed,... }
...
Initial conditions of $u, v$ and $y$ are set to $u_0=0.7, v_0=0.2, y_0=0.5$ (Fig. \ref{fig:circuit}a). %have been optimized for in \cite{Egger2020} and
...
\todo{subsection: merge to section 3 and add paragraph headings}
...
\todo{Motivate why we compare regimes: which one is better suited for simulation. Conclude in the end that intermediate regime is better.}
