...
These results are partially confirmed in gerbil data, suggesting an adjustment to accommodate stimulus statistics leads to better performance in cases of high variance. \todo{data from experiments with gerbils, unclear phrase}
